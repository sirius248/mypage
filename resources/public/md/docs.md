...
Two middleware functions are provided by default in the `longnblog.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `longnblog.handler` namespace to manage the enabled middleware.
